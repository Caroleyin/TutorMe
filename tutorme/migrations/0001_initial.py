    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('major', models.CharField(blank=True, default='', max_length=100, verbose_name='Major(s)/minor(s)')),
                ...
                ('courses', models.ManyToManyField(blank=True, to='tutorme.courseastext')),
